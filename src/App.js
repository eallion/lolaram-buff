...
import updateConfig from './update/13.15';
    ...
    return (
        ...
        >
            <div className="update" onClick={() => setIsOpen(true)}>
                <Badge dot>13.15版本更新内容</Badge>
            </div>
            <div className="header">
                <h1 className="title">英雄联盟极地大乱斗平衡属性一览 (V13.15)</h1>
            ...
            <div className="time">更新时间：2023/08/06&nbsp;15:00:00</div>
            <Modal
                title="版本更新"
                open={isOpen}
